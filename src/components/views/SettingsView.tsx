    ...
    <div className="space-y-6 animate-in fade-in duration-300 max-w-2xl mx-auto">
      ...
      <div className="glass-panel rounded-3xl p-6 border border-white/10 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-2xl bg-white/10 flex items-center justify-center text-[#d0bcff]">
            {theme === 'dark' ? <Moon className="w-5 h-5" /> : <Sun className="w-5 h-5 text-amber-300" />}
          </div>
          <div>
            ...
            <p className="text-xs text-[#cbc3d7] light:text-slate-500">
              Current mode: <strong className="text-white capitalize">{theme}</strong>
            </p>
          </div>
        </div>
      ...
      <div className="glass-panel rounded-3xl p-6 border border-white/10 space-y-4">
        ...
        <button
          ...
          className="w-full py-3 rounded-2xl bg-gradient-to-r from-[#d0bcff] to-[#ffb0cd] text-[#3c0091] font-bold text-xs flex items-center justify-center gap-2 shadow-md hover:shadow-lg transition-all"
        >
      ...
      <div className="glass-panel rounded-3xl p-6 border border-rose-500/20 space-y-4 bg-rose-500/5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-bold text-sm text-rose-400">Danger Zone</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
          <button
            ...
            className="w-full py-3 rounded-2xl bg-rose-500/20 hover:bg-rose-500/30 text-rose-300 border border-rose-500/30 font-bold text-xs transition-colors"
          >
          ...
          {onDeleteAccount && (
            <button
              ...
              className="w-full py-3 rounded-2xl bg-rose-600 hover:bg-rose-700 text-white font-bold text-xs transition-colors shadow-md"
            >
